...
with st.sidebar:
    ...
    if jd_input_type == "Select Benchmark JD":
        ...
        jd_file_path = {
            "Data Analyst": r"JD\data analyst jd.txt",
            "Frontend Developer": r"JD\frontend developer jd.txt",
            "Backend Developer": r"JD\back end developer jd.txt",
            "Full-stack Developer": r"JD\full stack developer jd.txt",
            "AI Engineer": r"JD\ai engineer jd.txt"
        }[selected_jd]
